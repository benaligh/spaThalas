 ...
 */
final class Version20210127190105 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service_option (service_id INT NOT NULL, option_id INT NOT NULL, INDEX IDX_64410586ED5CA9E6 (service_id), INDEX IDX_64410586A7C41D6F (option_id), PRIMARY KEY(service_id, option_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
